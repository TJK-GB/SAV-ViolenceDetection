...
save_path      = r"D:\UK\00. 2024 QMUL\00. Course\SAV-ViolenceDetection\Results\Model Training(w video)\Swin+GRU"
...
class SwinGRUClassifier(nn.Module):
    def __init__(self):
        ...
        # Earlyfusion configuration input
        self.gru = nn.GRU(input_size=768 + NUM_SRC_CLASSES,
