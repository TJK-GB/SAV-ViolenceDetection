...
save_path      = r"D:\UK\00. 2024 QMUL\00. Course\SAV-ViolenceDetection\Results\Model Training(w.o video)\Swin"
...
class SwinVideoClassifier(nn.Module):
    def __init__(self):
        ...
        self.swin.head = nn.Identity()   # remove classification head (ImageNet classification -> violent vs non-violent)
