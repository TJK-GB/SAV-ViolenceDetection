...
CKPT_PATH = r"D:\UK\00. 2024 QMUL\00. Course\SAV-ViolenceDetection\Results\Model Training(w.o video)\ResNet50+GRU\resnet50_gru_best.pt"
SAVE_DIR  = r"D:\UK\00. 2024 QMUL\00. Course\SAV-ViolenceDetection\Results\Interpretability\GradCAM_ResNet50GRU"
...
class GradCAM:
    ...
    def __call__(self, x):
        ...
        feats = self.model.cnn(x)   # only ResNet backbone, bypass GRU
        score = feats.mean()
...
if __name__ == "__main__":
    ...
    # adapt key names if needed (similar to CUE-NET case)
